...
static const flex_int16_t yy_nxt[21] =
    {   0,
        4,    5,    6,    4,    7,    4,    8,   11,   10,   10,
       12,    9,    3,   12,   12,   12,   12,   12,   12,   12
    } ;

static const flex_int16_t yy_chk[21] =
    {   0,
        1,    1,    1,    1,    1,    1,    1,   13,   10,    5,
        3,    2,   12,   12,   12,   12,   12,   12,   12,   12
    } ;
...
char *yytext;
#line 1 "assignmentfile.l"
#line 2 "assignmentfile.l"
#include <iostream>
#include <fstream>
#include <stdlib.h>
#include <string.h>
...
YY_RULE_SETUP
#line 28 "assignmentfile.l"
/* skip whitespace */
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 29 "assignmentfile.l"
{ cout << yytext << " ----> <" << yytext << '>' << endl; }
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 30 "assignmentfile.l"
{ cout << yytext << " ----> <" << yytext << '>' << endl; }
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 31 "assignmentfile.l"
{ cout << yytext << " ----> <" << yytext << '>' << endl; }
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 32 "assignmentfile.l"
{
